...
final class TextRecognitionService {
    ...
    private func process(
        ...
        for timer in existingTimers {
            ...
            // During partial scans, only delete when the timer is explicitly in the
            // dirty region. This keeps deletion granular while avoiding full-canvas
            // work on every recognition pass.
            if !stillPresent {
